...
# April 13, 2026
In my personal opinion, I belive that even with the advance technology we have isn't enough to make it through long missions like on the moon and traveling to mars. The Artemis II mission used technologies like life support systems which is temperature management, air purification, and removing humidity using renewable filters, this being crucial for long term missions in space. Another advance tech that they used were communication systems that would be a light based communication terminal this is a upgrade that allows high data rates up to 260 Megabits per second, compared from the traditional radion waves this is important for data transfer and live videos during long missions. The issues were that the waste management system that cost $23 million dollors to develop had a issue venting urine and along with a issue with the water pump, which is causing a buring smell and forcing the space crew to call backup, along with the communication blackout that occured as well. These problems are signs for important improvement, by these terms of issues in the systems require refinement especally on long term missions where resupply is nearly if not is impossible.
# April 20, 2026
It doesn't really matter if the music is made by a real artist nor AI, AI indeed can influence people the same way contain created by humans can, and no there is no reason to limit the used or how AI is used on social media. Because as much as songs made by humans became popular AI has some too (some I can't name bcause the AI songs that be trending on instagram, Tik Tok, and YouTube be a little too inappropiate for school purposes), songs that are popular from AI also came from game trailers like the free to play game "Where Winds Meet". This helps my answers because people on the Internet grew over not only to AI songs but AI animations, voices, and brainroot memes and yet those memes were also made into songs and were trending for odd reasons that we still don't understand to this day.
